"""autogenerated by genmsg_py from GraspActionResult.msg. Do not edit."""
...
class GraspActionResult(roslib.message.Message):
  _md5sum = "d1ff0ad4adeba5dbacee456cd58f4782"
  _type = "srs_grasping/GraspActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','srs_grasping/GraspResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = srs_grasping.msg.GraspResult()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = srs_grasping.msg.GraspResult()
