...
srs::COldIMarkersPlugin::COldIMarkersPlugin(const std::string & name)
...
srs::COldIMarkersPlugin::~COldIMarkersPlugin()
{
...
void srs::COldIMarkersPlugin::init(ros::NodeHandle & node_handle)
{
	...
	// Advertise services
	m_serviceInsertPlanes = node_handle.advertiseService("insert_plane", &srs::COldIMarkersPlugin::insertPlaneCallback, this);
 ...
 */
bool srs::COldIMarkersPlugin::insertPlaneCallback(srs_env_model::AddPlanes::Request & req,
 ...
 * @param plane Plane
 */
void srs::COldIMarkersPlugin::operatePlane(const srs_env_model_msgs::PlaneDesc & plane) {
 ...
 */
void srs::COldIMarkersPlugin::addPlaneSrvCall(const srs_env_model_msgs::PlaneDesc & plane,
 ...
 * @param plane Added plane
 */
void srs::COldIMarkersPlugin::removePlaneSrvCall(const srs_env_model_msgs::PlaneDesc & plane,
		const std::string & name)
{
	if( m_bUseExternalServer )
	{
 ...
 */
std::string srs::COldIMarkersPlugin::getUniqueName() {
	std::stringstream ss;
