...
namespace srs
{
    ...
    struct SMarkerArrayHolder : public  srs::CCrawlingPluginHolder< srs::CMarkerArrayPlugin, tpOctomapPlugin >
    {
    protected:
        /// Define holder type
        typedef srs::CCrawlingPluginHolder< srs::CMarkerArrayPlugin, tpOctomapPlugin > tMAHolder;
