...
namespace srs
{
    ...
    struct SCMapPluginHolder : public  srs::CCrawlingPluginHolder< srs::CCMapPlugin, tpOctomapPlugin >
    {
    protected:
        /// Define holder type
        typedef srs::CCrawlingPluginHolder< srs::CCMapPlugin, tpOctomapPlugin > tCMPHolder;
