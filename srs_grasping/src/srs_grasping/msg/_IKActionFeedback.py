"""autogenerated by genmsg_py from IKActionFeedback.msg. Do not edit."""
...
class IKActionFeedback(roslib.message.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "srs_grasping/IKActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','srs_grasping/IKFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = srs_grasping.msg.IKFeedback()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = srs_grasping.msg.IKFeedback()
