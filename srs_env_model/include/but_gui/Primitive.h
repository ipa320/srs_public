 ...
 * \file
 *
 * $Id: Primitive.h 603 2012-04-16 10:50:03Z xlokaj03 $
 *
...
public:
  ...
  /**
   * @brief Sets specified grasping position
   * @param pos_num is specified position number (1-6)
   * @position is grasping position
   */
  void addPreGraspPosition(int pos_id, Vector3 position);

  /**
   * @brief Removes specified grasping position
   * @param pos_num is specified position number (1-6)
   */
