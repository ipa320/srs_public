...
"""
  ...
  _slot_types = ['geometry_msgs/Pose','srs_symbolic_grounding/SRSSpatialInfo','srs_symbolic_grounding/SRSSpatialInfo[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.parent_obj_geometry is None:
        self.parent_obj_geometry = srs_symbolic_grounding.msg.SRSSpatialInfo()
