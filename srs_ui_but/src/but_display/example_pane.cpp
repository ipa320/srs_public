 ...
 * \file
 *
 * $Id: example_pane.cpp 825 2012-05-23 14:29:07Z spanel $
 *
...
/**
 Constructor
 */
srs_ui_but::CExamplePanel::CExamplePanel(wxWindow *parent, const wxString& title, rviz::WindowManagerInterface * wmi)
...
*/
void srs_ui_but::CExamplePanel::OnQuit(wxCommandEvent& event)
{
...
/**
 Constructor
 */
srs_ui_but::CExampleDialog::CExampleDialog(wxWindow *parent, const wxString& title)
...
/**
    On quit command event handler
*/
void srs_ui_but::CExampleDialog::OnQuit(wxCommandEvent& event)
{
    std::cerr << "Close called..." << std::endl;
    Close(true);
}
...
/**
 Constructor
 */
srs_ui_but::CExamplePanelControls::CExamplePanelControls(wxWindow *parent, const wxString& title, rviz::WindowManagerInterface * wmi )
    : wxPanel( parent, wxID_ANY, wxDefaultPosition, wxSize(280, 180), wxTAB_TRAVERSAL, title)
    , m_wmi( wmi )
{
    // Create controls
...
/**
    On checkbox toggle
   */
void srs_ui_but::CExamplePanelControls::OnChckToggle(wxCommandEvent& event)
{
    if( m_chkb->GetValue() )
...
/**
    On quit command event handler
*/
void srs_ui_but::CExamplePanelControls::OnReset(wxCommandEvent& event)
{
