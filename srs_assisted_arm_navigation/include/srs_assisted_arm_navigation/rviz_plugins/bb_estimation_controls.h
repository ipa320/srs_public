...
#include "srs_assisted_arm_navigation/ManualBBEstimationAction.h"
...
protected:
    ...
    typedef actionlib::SimpleActionServer<srs_assisted_arm_navigation::ManualBBEstimationAction> bb_est_action_server;
    ...
    ManualBBEstimationGoalConstPtr goal_;
    ManualBBEstimationFeedback fb_;
