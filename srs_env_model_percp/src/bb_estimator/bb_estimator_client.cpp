...
void sendRequest(Point2i p1, Point2i p2)
{
    ...
    if(bbEstimateClient.call(srv)) 
    {
        ...
        else
        {
            ...
            std::string errMsg = "Failed to call service " + BB_ESTIMATOR_EstimateRect_SRV + ".";
...
int main(int argc, char **argv)
{
    ...
    rectEstimateClient = n.serviceClient<srs_env_model_percp::EstimateRect>(BB_ESTIMATOR_EstimateRect_SRV);
