...
class SymbolGroundingScanBasePoseRequest(roslib.message.Message):
  _md5sum = "4f0bc52e9c5c3deb70f9429f11eb88c2"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_7d3f.pack(_x.parent_obj_geometry.pose.position.x, _x.parent_obj_geometry.pose.position.y, _x.parent_obj_geometry.pose.position.z, _x.parent_obj_geometry.pose.orientation.x, _x.parent_obj_geometry.pose.orientation.y, _x.parent_obj_geometry.pose.orientation.z, _x.parent_obj_geometry.pose.orientation.w, _x.parent_obj_geometry.l, _x.parent_obj_geometry.w, _x.parent_obj_geometry.h))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.parent_obj_geometry.pose.position.x, _x.parent_obj_geometry.pose.position.y, _x.parent_obj_geometry.pose.position.z, _x.parent_obj_geometry.pose.orientation.x, _x.parent_obj_geometry.pose.orientation.y, _x.parent_obj_geometry.pose.orientation.z, _x.parent_obj_geometry.pose.orientation.w, _x.parent_obj_geometry.l, _x.parent_obj_geometry.w, _x.parent_obj_geometry.h,) = _struct_7d3f.unpack(str[start:end])
      start = end
      end += 4
...
class SymbolGroundingScanBasePose(roslib.message.ServiceDefinition):
  ...
  _md5sum = 'fc9c0d09a68833e3f8ccea2b1ee9c77a'
