...
# Definitions
#-------------------------------------------------------------------------------
BUT_SetContext_SRV = 'but_context/set_context'
BUT_GetContext_SRV = 'but_context/get_context'

BUT_GetAllPrimitivesNames_SRV = 'but_gui/get_all_primitives_names'
BUT_ChangeColor_SRV = 'but_gui/change_color'

BUT_ContextChanged_TOPIC = 'but_context/context_changed'
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
...
class ContextServer(object):
    ...
    _contextChangedPublisher = rospy.Publisher(BUT_ContextChanged_TOPIC,
                                               ContextChanged)
    ...
    def _set_emergency_status(self):
        ...
        rospy.wait_for_service(BUT_GetAllPrimitivesNames_SRV)
        get_all_primitives_names_service = rospy.ServiceProxy(BUT_GetAllPrimitivesNames_SRV, GetAllPrimitivesNames)
        try:
        ...
        rospy.wait_for_service(BUT_ChangeColor_SRV)
        change_color_service = rospy.ServiceProxy(BUT_ChangeColor_SRV, ChangeColor)
...
if __name__ == '__main__':
    ...
    sc = rospy.Service(BUT_SetContext_SRV, srs_env_model.srv.SetContext, 
                       contextServer.set_context)
    gt = rospy.Service(BUT_GetContext_SRV, srs_env_model.srv.GetContext, 
