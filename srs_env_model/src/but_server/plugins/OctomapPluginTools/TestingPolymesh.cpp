 ...
 * Simple constructor
 */
srs::CTestingPolymesh::CTestingPolymesh()
{
 ...
 */
srs::CTestingPolymesh::CTestingPolymesh(const tPoint &center, const tQuaternion &orientation, const tPoint & size)
{
 ...
 */
void srs::CTestingPolymesh::setAsBox(const tPoint &center, const tQuaternion &orientation, const tPoint & size)
{
	// Corners
	tPoint points[8];
