...
#define INTERACTION_PRIMITIVES_UPDATE_TOPIC(marker_name,topic) srs_interaction_primitives::PACKAGE_NAME_PREFIX + "/" + std::string(marker_name) + "/update" + std::string(topic)
