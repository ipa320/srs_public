...
#pragma once
#ifndef BUT_SEG_UTILS_FILTERING_H
#define BUT_SEG_UTILS_FILTERING_H
...
namespace srs_env_model_percp
{
	...
	class Regions
	{
		public:
			 ...
			 */
			static void gradientPlanePredictor(cv::Mat &src, cv::Mat& dst, float differenceThreshold = 0.02, int size = 2, int sobelSize = 5);//, Mat& normals, Mat& coefs, Mat& points);
...
} // namespace but_seg_utils
#endif // BUT_SEG_UTILS_FILTERING_H
