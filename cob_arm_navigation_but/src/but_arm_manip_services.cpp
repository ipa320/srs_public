...
bool CArmManipulationEditor::ArmNavNew(cob_arm_navigation_but::ArmNavNew::Request &req, cob_arm_navigation_but::ArmNavNew::Response &res) {
   ...
   // TODO why it's not possible to add more objects?? -> Size mismatch between poses size 2 and shapes size 1
...
bool CArmManipulationEditor::ArmNavPlan(cob_arm_navigation_but::ArmNavPlan::Request &req, cob_arm_navigation_but::ArmNavPlan::Response &res) {
...
bool CArmManipulationEditor::ArmNavPlay(cob_arm_navigation_but::ArmNavPlay::Request &req, cob_arm_navigation_but::ArmNavPlay::Response &res) {
...
bool CArmManipulationEditor::ArmNavExecute(cob_arm_navigation_but::ArmNavExecute::Request &req, cob_arm_navigation_but::ArmNavExecute::Response &res) {
...
bool CArmManipulationEditor::ArmNavReset(cob_arm_navigation_but::ArmNavReset::Request &req, cob_arm_navigation_but::ArmNavReset::Response &res) {
...
bool CArmManipulationEditor::ArmNavSuccess(cob_arm_navigation_but::ArmNavSuccess::Request &req, cob_arm_navigation_but::ArmNavSuccess::Response &res) {
...
bool CArmManipulationEditor::ArmNavFailed(cob_arm_navigation_but::ArmNavFailed::Request &req, cob_arm_navigation_but::ArmNavFailed::Response &res) {
...
bool CArmManipulationEditor::ArmNavRefresh(cob_arm_navigation_but::ArmNavRefresh::Request &req, cob_arm_navigation_but::ArmNavRefresh::Response &res) {
...
bool CArmManipulationEditor::ArmNavCollObj(cob_arm_navigation_but::ArmNavCollObj::Request &req, cob_arm_navigation_but::ArmNavCollObj::Response &res) {
