	...
	if ((parent_obj_th >= 0) & (parent_obj_th <= (45.0 / 180.0 * math.pi))) | ((parent_obj_th >= (135.0 / 180.0 * math.pi)) & (parent_obj_th <= (225.0 / 180.0 * math.pi))) | ((parent_obj_th >= (315.0 / 180.0 * math.pi)) & (parent_obj_th < 360)):
		...
		while index_1 < len(wall_checked_scan_base_pose_list_1):
			...
			while index_2 < len(furniture_geometry_list):
				delta_x = math.sqrt((wall_checked_scan_base_pose_list_1[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_1[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.cos(math.atan((wall_checked_scan_base_pose_list_1[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_1[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
				delta_y = math.sqrt((wall_checked_scan_base_pose_list_1[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_1[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.sin(math.atan((wall_checked_scan_base_pose_list_1[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_1[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
		...
		while index_1 < len(wall_checked_scan_base_pose_list_2):
			index_2 = 0
			while index_2 < len(furniture_geometry_list):
				delta_x = math.sqrt((wall_checked_scan_base_pose_list_2[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_2[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.cos(math.atan((wall_checked_scan_base_pose_list_2[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_2[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
				delta_y = math.sqrt((wall_checked_scan_base_pose_list_2[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_2[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.sin(math.atan((wall_checked_scan_base_pose_list_2[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_2[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
				if delta_x >= -(furniture_geometry_list[index_2].w / 2.0 + 0.5) and delta_x <= (furniture_geometry_list[index_2].w / 2.0 + 0.5) and delta_y >= -(furniture_geometry_list[index_2].l / 2.0 + 0.5) and delta_y <= (furniture_geometry_list[index_2].l / 2.0 + 0.5):
					break
				else:
					index_2 += 1
		...
		while index_1 < len(wall_checked_scan_base_pose_list_3):
			index_2 = 0
			while index_2 < len(furniture_geometry_list):
				delta_x = math.sqrt((wall_checked_scan_base_pose_list_3[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_3[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.cos(math.atan((wall_checked_scan_base_pose_list_3[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_3[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
				delta_y = math.sqrt((wall_checked_scan_base_pose_list_3[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_3[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.sin(math.atan((wall_checked_scan_base_pose_list_3[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_3[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
				if delta_x >= -(furniture_geometry_list[index_2].w / 2.0 + 0.5) and delta_x <= (furniture_geometry_list[index_2].w / 2.0 + 0.5) and delta_y >= -(furniture_geometry_list[index_2].l / 2.0 + 0.5) and delta_y <= (furniture_geometry_list[index_2].l / 2.0 + 0.5):
					break
				else:
					index_2 += 1
		...
		while index_1 < len(wall_checked_scan_base_pose_list_4):
			index_2 = 0
			while index_2 < len(furniture_geometry_list):
				delta_x = math.sqrt((wall_checked_scan_base_pose_list_4[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_4[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.cos(math.atan((wall_checked_scan_base_pose_list_4[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_4[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
				delta_y = math.sqrt((wall_checked_scan_base_pose_list_4[index_1].x - furniture_geometry_list[index_2].pose.x) ** 2 + (wall_checked_scan_base_pose_list_4[index_1].y - furniture_geometry_list[index_2].pose.y) ** 2) * math.sin(math.atan((wall_checked_scan_base_pose_list_4[index_1].y - furniture_geometry_list[index_2].pose.y) / (wall_checked_scan_base_pose_list_4[index_1].x - furniture_geometry_list[index_2].pose.x))-furniture_geometry_list[index_2].pose.theta)
				if delta_x >= -(furniture_geometry_list[index_2].w / 2.0 + 0.5) and delta_x <= (furniture_geometry_list[index_2].w / 2.0 + 0.5) and delta_y >= -(furniture_geometry_list[index_2].l / 2.0 + 0.5) and delta_y <= (furniture_geometry_list[index_2].l / 2.0 + 0.5):
					break
				else:
					index_2 += 1
