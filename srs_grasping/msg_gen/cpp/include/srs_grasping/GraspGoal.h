...
private:
  static const char* __s_getMD5Sum_() { return "d45be6390fc6d4b75d732cc8641c65dd"; }
public:
...
struct MD5Sum< ::srs_grasping::GraspGoal_<ContainerAllocator> > {
  ...
  {
    return "d45be6390fc6d4b75d732cc8641c65dd";
  }

  static const char* value(const  ::srs_grasping::GraspGoal_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xd45be6390fc6d4b7ULL;
  static const uint64_t static_value2 = 0x5d732cc8641c65ddULL;
};
