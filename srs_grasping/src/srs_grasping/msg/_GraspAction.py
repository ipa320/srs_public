...
class GraspAction(roslib.message.Message):
  _md5sum = "52cb8aaf5c75acb515413b6d1a7ea122"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_goal.goal.object_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_goal.goal.object_id,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
