"""autogenerated by genmsg_py from GraspActionFeedback.msg. Do not edit."""
...
class GraspActionFeedback(roslib.message.Message):
  _md5sum = "addd29788870be11081501429fc0d31c"
  _type = "srs_grasping/GraspActionFeedback"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','srs_grasping/GraspFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = srs_grasping.msg.GraspFeedback()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = srs_grasping.msg.GraspFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.feedback.fb = str[start:end]
      return self
