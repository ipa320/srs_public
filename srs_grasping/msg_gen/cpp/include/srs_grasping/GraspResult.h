...
private:
  static const char* __s_getMD5Sum_() { return "eab730440692481ec12770602c3365c8"; }
public:
...
struct MD5Sum< ::srs_grasping::GraspResult_<ContainerAllocator> > {
  ...
  {
    return "eab730440692481ec12770602c3365c8";
  }

  static const char* value(const  ::srs_grasping::GraspResult_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xeab730440692481eULL;
  static const uint64_t static_value2 = 0xc12770602c3365c8ULL;
};
