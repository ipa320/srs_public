 ...
 * Constructor
 */
CButCobDisplay::CButCobDisplay(const std::string & name,rviz::VisualizationManager * manager)
    ...
    , m_listener( this )
{
    ...
    vis_manager_->getViewControllerTypeChangedSignal().connect( boost::bind(&CButCobDisplay::onViewControllerChange, this, _1 ) );
 ...
 *  Create geometry
 */
bool CButCobDisplay::createGeometry()
{
...
void CButCobDisplay::destroyGeometry()
{
...
//! Update display
void CButCobDisplay::update (float wall_dt, float ros_dt)
{
 ...
 */
void CButCobDisplay::onViewControllerChange( rviz::ViewController * c )
{
    connectListener();
}
 ...
 * Connect listener
 */
void CButCobDisplay::connectListener()
{
...
void CButCobDisplay::propertyPositionChanged()
{
    if( ! m_property_position.expired() )
    {
...
/**
  ...
  */
CButCobDisplay::CNotifyCameraListener::CNotifyCameraListener( CButCobDisplay * display )
...
/**
  ...
  */
void CButCobDisplay::CNotifyCameraListener::connect( Ogre::Camera * camera )
{
    // Old connection
    disconnect();
...
/**
  ...
  */
bool CButCobDisplay::CNotifyCameraListener::hasMoved( const Ogre::Vector3 & position, const Ogre::Quaternion & orientation )
{
...
/**
  ...
  */
void CButCobDisplay::CNotifyCameraListener::changedCB( const Ogre::Vector3 & position, const Ogre::Quaternion & orientation )
{
...
/**
  ...
  */
void CButCobDisplay::CNotifyCameraListener::disconnect()
{
    if( m_camera != 0 )
    {
...
/**
  ...
  */
const std::string CButCobDisplay::getCameraPositionString()
{
    std::stringstream ss;
...
/**
  ...
  */
void CButCobDisplay::setCameraPositionString( const std::string & str )
{
