...
public:
   ...
   * @brief Constructor
   */
  CButDistanceCircularIndicator(const std::string & name, rviz::VisualizationManager * manager);
...
protected:
  ...
  rviz::FloatPropertyWPtr m_property_alpha_, m_property_thickness_, m_property_radius_;
  rviz::IntPropertyWPtr m_property_levels_;
  rviz::BoolPropertyWPtr m_property_show_distance_;
