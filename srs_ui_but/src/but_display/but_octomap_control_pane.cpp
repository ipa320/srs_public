...
#define RESET_OCTOMAP_SERVICE_NAME "/but_server_node/reset_octomap"
#define GIZMO_POSE_TOPIC "/but_interaction_primitives/OctomapClearingBoxGizmo/update/pose_changed"
#define GIZMO_SCALE_TOPIC "/but_interaction_primitives/OctomapClearingBoxGizmo/update/scale_changed"
#define CLEAR_OCTOMAP_BOX_SERVICE_NAME "/but_server_node/remove_cube"
 ...
 *On cancel clera map
 */
void COctomapControlPane::OnCancelClear( wxCommandEvent &event )
{
	// remove gizmo
	removeGizmo();
 ...
 */
void COctomapControlPane::gizmoPoseCB( const srs_interaction_primitives::PoseChangedConstPtr &marker_update )
{
 ...
 * Gizmo pose topic callback
 */
void COctomapControlPane::gizmoScaleCB( const srs_interaction_primitives::ScaleChangedConstPtr &marker_update )
{
	if( marker_update->marker_name != GIZMO_NAME )
		return;
 ...
 */
void COctomapControlPane::setGizmoPoseScale()
{
...
BEGIN_EVENT_TABLE(COctomapControlPane, wxPanel)
    ...
    EVT_BUTTON(ID_CANCEL_BUTTON,  COctomapControlPane::OnCancelClear)
END_EVENT_TABLE()
