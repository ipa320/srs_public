...
public:
	CMaterialListener( const std::string & materialName, const std::string & groupName )
	{
		// Create material
 ...
 *  Constructor
 */
srs_ui_but::CButMaterialTest1::CButMaterialTest1(const std::string & name,rviz::VisualizationManager * manager)
...
, m_bPublish(true)
{
  ...
  if( wi != 0 )
  {
    ...
    if( m_pane != 0 )
    {
      ...
      // Connect signal
      m_pane->getSigChckBox().connect( boost::bind( &CButMaterialTest1::onPublishStateChanged, this, _1) );
      m_pane->getSigSave().connect( boost::bind( &CButMaterialTest1::onSave, this, _1 ) );
    }
  ...
  m_timer = private_nh.createTimer( ros::Duration(m_timerPeriod), boost::bind( &CButMaterialTest1::onTimerPublish, this, _1) );
 ...
 *  Destructor
 */
srs_ui_but::CButMaterialTest1::~CButMaterialTest1()
{
 ...
 */
void srs_ui_but::CButMaterialTest1::onEnable()
{
 ...
 */
void srs_ui_but::CButMaterialTest1::onDisable()
{
  m_sceneNode->setVisible( false );
}

void srs_ui_but::CButMaterialTest1::createMaterials(Ogre::Camera * camera)
{
	...
	Ogre::String nameOfResourceGroup( "MaterialGroup1" );
	{
		...
		Ogre::String resource_path(package_path + "/src/but_projection/materials");
	...
	// Load compositor
	{
		...
		else
		{
			...
			CMaterialListener *gml = new CMaterialListener( "depth", "srs_ui_but" );
 ...
 *  Create geometry
 */
bool srs_ui_but::CButMaterialTest1::createGeometry(const ros::NodeHandle & nh)
{
  // Get camera.
...
void srs_ui_but::CButMaterialTest1::destroyGeometry()
{
  // Destroy scene
  if( m_sceneNode != 0 )
...
//! Update display
void srs_ui_but::CButMaterialTest1::update (float wall_dt, float ros_dt)
{
  rviz::RenderPanel * panel = vis_manager_->getRenderPanel();
  if( panel == 0 )
  {
...
void srs_ui_but::CButMaterialTest1::onTimerPublish(const ros::TimerEvent&)
{
...
*/
void srs_ui_but::CButMaterialTest1::onPublishStateChanged(bool state)
{
  if( state )
    m_timer.start();
  else
...
* On save screenshot
*/
void srs_ui_but::CButMaterialTest1::onSave( std::string filename )
{
...
srs_ui_but::CButMaterialTest1::CControllPane::CControllPane(wxWindow *parent, const wxString& title, rviz::WindowManagerInterface * wmi): wxPanel( parent, wxID_ANY, wxDefaultPosition, wxSize(280, 180), wxTAB_TRAVERSAL, title)
, m_wmi( wmi )
{
  // Create controls
...
On checkbox toggle
*/
void srs_ui_but::CButMaterialTest1::CControllPane::OnChckToggle(wxCommandEvent& event)
{
  // Call signal
...
*/
void srs_ui_but::CButMaterialTest1::CControllPane::OnSave(wxCommandEvent& event)
{
...
///////////////////////////////////////////////////////////////////////////////
BEGIN_EVENT_TABLE(srs_ui_but::CButMaterialTest1::CControllPane, wxPanel)
EVT_BUTTON(ID_SAVE_BUTTON,  srs_ui_but::CButMaterialTest1::CControllPane::OnSave)
EVT_CHECKBOX(ID_CHECKBOX, srs_ui_but::CButMaterialTest1::CControllPane::OnChckToggle )
END_EVENT_TABLE()
