"""autogenerated by genmsg_py from SymbolGroundingScanBaseRegionRequest.msg. Do not edit."""
...
class SymbolGroundingScanBaseRegionRequest(roslib.message.Message):
  _md5sum = "23cc208c15dce6f450656fc4c209b68c"
  _type = "srs_symbolic_grounding/SymbolGroundingScanBaseRegionRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SymbolGroundingScanBaseRegionRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genmsg_py from SymbolGroundingScanBaseRegionResponse.msg. Do not edit."""
import roslib.message
import struct

import geometry_msgs.msg

class SymbolGroundingScanBaseRegionResponse(roslib.message.Message):
  _md5sum = "336c916541002c9b5379743669a22b3f"
  _type = "srs_symbolic_grounding/SymbolGroundingScanBaseRegionResponse"
  _has_header = False #flag to mark the presence of a Header object
...
float64 theta
"""
  __slots__ = ['scan_base_pose_list','R']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SymbolGroundingScanBaseRegionResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_f.pack(self.R))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.R,) = _struct_f.unpack(str[start:end])
      return self
    except struct.error as e:
      raise roslib.message.DeserializationError(e) #most likely buffer underfill
...
_struct_3d = struct.Struct("<3d")
class SymbolGroundingScanBaseRegion(roslib.message.ServiceDefinition):
  _type          = 'srs_symbolic_grounding/SymbolGroundingScanBaseRegion'
  _md5sum = 'f3a35a97f0108a9ffe2888b385d0e10a'
  _request_class  = SymbolGroundingScanBaseRegionRequest
  _response_class = SymbolGroundingScanBaseRegionResponse
