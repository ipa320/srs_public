...
#define MARKERARRAY_PUBLISHER_NAME std::string("butsrv_markerarray_object")
#define MARKERARRAY_FRAME_ID std::string("/map")


srs::CMarkerArrayPlugin::CMarkerArrayPlugin(const std::string & name)
...
srs::CMarkerArrayPlugin::~CMarkerArrayPlugin()
{
    if( m_data != 0 )
        delete m_data;
}
...
bool srs::CMarkerArrayPlugin::shouldPublish()
{
...
void srs::CMarkerArrayPlugin::init(ros::NodeHandle & node_handle)
{
...
void srs::CMarkerArrayPlugin::onPublish(const ros::Time & timestamp)
{
...
void srs::CMarkerArrayPlugin::onFrameStart(const SMapParameters & par)
{
...
void srs::CMarkerArrayPlugin::handleNode(const srs::tButServerOcTree::iterator & it, const SMapParameters & mp)
{
...
void srs::CMarkerArrayPlugin::handlePostNodeTraversal(const SMapParameters & mp)
{
...
std_msgs::ColorRGBA srs::CMarkerArrayPlugin::heightMapColor(double h) const {
